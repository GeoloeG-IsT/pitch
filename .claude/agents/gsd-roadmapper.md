...
Reference full template: `/home/pascal/wks/pitch/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/pascal/wks/pitch/.claude/get-shit-done/templates/state.md`.
